...
function renderList(filteredProducts){
    ...
    filteredProducts.map((product)=>`<div class="col-md-4">
          <div class="card text-black" style='width:18rem; background-color:yellow; margin-top: 20px'>
            <div class="card-body">
              ...
              <button class="btn btn-success" onclick='editProd(${product.id})'  data-toggle="modal" data-target="#exampleModal">Edit</button>
